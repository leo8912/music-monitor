...
## 📚 文档指南
为了便于查阅和技术交接，本项目的文档遵循分类归档原则：
- **API 与交付**:
  - `文档/API与前后端交互规范.md`: Core Schema 及前端对接指南。
  - `文档/后端服务架构说明.md`: Service Layer 全景参考。
  - `文档/外部接口参考_GDStudio.md`: 外部平台调用说明。
- **系统分析与规划**:
  - 请移步 `需求/` 目录查看功能规划、方案存档与审查报告分析。
- **测试与验证**:
  - 请移步 `测试/` 看取各模块详细验收方案。
